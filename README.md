...
[项目说明](https://github.com/MLNLP-World/Paper_Writing_Tips/blob/main/README.md#项目说明),
...
[大佬们的写作建议](https://github.com/MLNLP-World/Paper_Writing_Tips/blob/main/README.md#大佬们的写作建议), 
...
所有内容仅仅来自于笔者的个人经验，互联网数据，及笔者团队日常科研工作中的相关积累，以及笔者团队身边各位大佬的言传身教。有任何问题，欢迎联系。
...
#### 28.  检查是否超页（最后时刻慎重勿随意改图表大小）

#### 29.  检查标题和摘要与投稿系统填写框内的信息是否对应。

#### 30.  检查提交的数据与代码，不能包含个人信息，尤其 code 里面一些 hard coded 的模型或数据路径等需要处理掉，另外需要注意隐藏文件夹（如 .git）

#### 31.  Overleaf 在部分会议投稿前可能访问缓慢，请注意LaTex备份

#### 32.  论文的历史版本可以用时间编号，避免提交的不是最终版本

#### 33.  截稿前一天最好提前交一个版本的论文以及附录，防止截稿时服务器崩溃

#### 34.  交稿后仍需要关注会议官网和注册邮箱，以及时收到可能存在的会议截稿日期延后的消息。
